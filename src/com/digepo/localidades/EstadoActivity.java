...
/**
 * Clase EstadoActivity. Clase para la pantalla de informacion de Estado.
 */
public class EstadoActivity extends Activity {

	/** 
	 * Botones graf* son usados para controlar la animacion de forma individual
	 * y lanzar las pantallas de información showGraf*() 
	 * */
